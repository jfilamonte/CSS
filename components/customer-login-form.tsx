...
export default function CustomerLoginForm() {
  ...
  const [state, formAction] = useActionState(signInCustomer, null)
  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="space-y-2 text-center">
        ...
        <p className="text-lg text-gray-400">Access your project information</p>
      </div>
      ...
      <form action={formAction} className="space-y-6">
        ...
        <div className="text-center text-gray-400">
          ...
          <Link href="/auth/customer-register" className="text-white hover:underline">
            Create one here
          </Link>
          <br />
